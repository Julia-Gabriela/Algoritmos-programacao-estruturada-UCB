   ...
   do{
    ...
    scanf("%d", &opcao);
        ...
        case 1:
            ...
            {
                result = num1 - num2;
                printf("A subtracao dos numeros %.lf e %.lf e igual a %.lf\n", num1, num2, result);
            }
            else if (operacao == '*')
            {
                result = num1 * num2;
                printf("A multiplicacao dos numeros %.lf e %.lf e igual a %.lf\n", num1, num2, result);
            }
            else if (operacao == '/')
            {
                result = num1 / num2;
                if (num2 != 0)
                {
                    printf("A divisao dos numeros %.lf e %.lf e igual a %.2lf\n", num1, num2, result);
                }
                else
                {
